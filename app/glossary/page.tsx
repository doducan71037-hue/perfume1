  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 py-32 min-h-screen">
      <div className="max-w-4xl">
        ...
        <p className="text-gray-400 text-xl font-light mb-24">
          Technical terminology of the olfactory arts.
        </p>
      </div>
      ...
      <div className="border-t border-black">
        {MOCK_GLOSSARY.map((item, idx) => (
          <div
            key={`${item.term}-${idx}`}
            className="grid grid-cols-1 md:grid-cols-12 gap-8 py-12 border-b border-gray-100 hover:bg-gray-50 transition-colors px-4 -mx-4"
          >
